...
<div class="container">
    ...
    <div class="row justify-content-center">
        <h1 class="rounded-5 bg-success text-dark text-center mt-3 ">Student Details Form!!</h1>
        <form action="insert" method="post" name="studentForm" class="col-lg-5 col-md-8 col-sm-12 rounded-4 shadow-lg p-5 bg-info text-dark">
            ...
            <div class="row justify content-end">
                <div>
                <label class="mt-2 text-bg-primary text-center rounded-4">Current  Address</label>
                    <div class="form group">
                ...
                <div>
                <label class="mt-2 text-bg-primary rounded-4 text-center">Permanant address</label>
                <div class="form group">
                    <label>Door Number</label>
